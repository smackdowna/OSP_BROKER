...
router.get('/', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, business_controller_1.businessController.getAllBusinesses);
router.get('/:id', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, business_controller_1.businessController.getBusinessById);
router.put('/:id', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, business_controller_1.businessController.updateBusiness);
router.delete('/:id', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, business_controller_1.businessController.deleteBusiness);
