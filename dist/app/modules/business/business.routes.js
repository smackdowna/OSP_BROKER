...
router.get('/representative/:id', business_controller_1.businessController.getRepresentativeById);
router.get('/representatives/:businessId', business_controller_1.businessController.getRepresentativeByBusinessId);
...
router.post('/representative/role/:userId', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, (0, authorizeRole_1.authorizeRole)("BUSINESS_ADMIN"), business_controller_1.businessController.updateRepresentativeRole);
...
router.get('/', business_controller_1.businessController.getAllBusinesses);
router.get('/businessAdmin', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, business_controller_1.businessController.getBusinessByBusinessAdminUserId);
