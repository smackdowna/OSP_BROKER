...
// Membership routes
router.post("/", requireAuth_1.verifyToken, membership_controller_1.membershipController.createMembershipPlan);
...
router.put("/:id", requireAuth_1.verifyToken, membership_controller_1.membershipController.updateMembershipPlan);
router.delete("/:id", requireAuth_1.verifyToken, membership_controller_1.membershipController.deleteMembershipPlan);
...
router.put("/userMembership/:id", requireAuth_1.verifyToken, membership_controller_1.membershipController.updateUserMembership);
router.delete("/userMembership/:id", requireAuth_1.verifyToken, membership_controller_1.membershipController.deleteUserMembership);
