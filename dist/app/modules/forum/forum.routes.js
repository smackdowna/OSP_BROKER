...
router.get('/topics', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, topic_controller_1.topicController.getAllTopics);
...
// Comment routes
router.post('/comment/:commenterId', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, comment_controller_1.commentController.createComment);
router.get('/comments', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, comment_controller_1.commentController.getAllComments);
...
router.delete('/comment/:id', requireAuth_1.verifyToken, (0, authorizeRole_1.authorizeRole)("MODERATOR"), comment_controller_1.commentController.deleteComment);
...
// Forum routes
router.post('/', requireAuth_1.verifyToken, (0, authorizeRole_1.authorizeRole)("MODERATOR"), forum_controller_1.forumControllers.createForum);
router.get('/', requireAuth_1.verifyToken, authorizeMembership_1.verifyMembership, forum_controller_1.forumControllers.getAllForums);
