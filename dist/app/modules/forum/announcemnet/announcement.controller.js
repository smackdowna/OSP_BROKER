...
const createAnnouncement = (0, catchAsyncError_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newAnnouncement = yield announcement_services_1.announcementServices.createAnnouncement({ title, description, forumId });
...
const getAnnouncementsByForumId = (0, catchAsyncError_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const { forumId } = req.params;
    const announcements = yield announcement_services_1.announcementServices.getAnnouncementsByForumId(forumId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const getAnnouncementById = (0, catchAsyncError_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const announcement = yield announcement_services_1.announcementServices.getAnnouncementById(forumdId, id, res);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
