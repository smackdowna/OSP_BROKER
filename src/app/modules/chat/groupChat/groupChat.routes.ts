...
router.post("/softDelete/:groupChatId", verifyToken, verifyMembership, authorizeRole("BUSINESS_ADMIN"), groupChatController.softDeleteGroupChat);
...
router.post("/message/softDelete/:groupchatId/:messageId", verifyToken, groupChatController.softDeleteGroupMessage);
