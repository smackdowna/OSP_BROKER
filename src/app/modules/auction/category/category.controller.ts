...
const softDeleteAuctionCategory = catchAsyncError(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.params;
  await categoryServices.softDeleteAuctionCategory(id, res);
  sendResponse(res, {
    statusCode: 200,
    success: true,
